...
func assetsTemplatesCmakeCmakelistsappTxtTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/templates/cmake/CMakeListsApp.txt.tpl", size: 1369, mode: os.FileMode(420), modTime: time.Unix(1528652595, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsTemplatesCmakeCmakelistspkgheaderonlyTxtTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/templates/cmake/CMakeListsPkgHeaderOnly.txt.tpl", size: 1581, mode: os.FileMode(420), modTime: time.Unix(1528652381, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
