...
func assetsTemplatesConfigAppHelperTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/templates/config/app-helper.txt", size: 577, mode: os.FileMode(420), modTime: time.Unix(1527450523, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsTemplatesConfigDependenciesHelperTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/templates/config/dependencies-helper.txt", size: 725, mode: os.FileMode(420), modTime: time.Unix(1527450523, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsTemplatesConfigTargetsHelperTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/templates/config/targets-helper.txt", size: 301, mode: os.FileMode(420), modTime: time.Unix(1527450523, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
